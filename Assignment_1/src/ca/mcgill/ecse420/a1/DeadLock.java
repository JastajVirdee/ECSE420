...
/**
 * Class to simulate deadlock
 * 2 locks are initialized and 2 threads are run.
 * Boths threads try to acquire both locks and this leads to deadlock
 * as the threads are holding the others lock.
 */
